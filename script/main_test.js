(function() {
    ...
    var stove = new Tset(false, false);
    var teabox = new Tset(false, false);
    var pot = new Tset(false, false);
    var cup = new Tset(false, false);
    var leaves = new Tset(false, false);
    var pcup = new Tset(false, false);
    var scup = new Tset(false, false);
    ...
    */
    ...
    function brew_teabox() {
        $('#teabox').click(function() {
            if (teabox.click == true) {
